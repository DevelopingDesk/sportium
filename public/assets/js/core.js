...
//    }
    ...
    $('#datatable-example .group-checkable').change(function () {
        if ($(this).prop('checked')) {
            $('#datatable-example tbody tr td input[type="checkbox"]').each(function () {
    ...
    $('#example .group-checkable').change(function () {
        if ($(this).prop('checked')) {
...
$(document).ready(function () {
    ...
    $(document).on('click', '.markaction #del', function (e) {
        ...
        var selectedCheckboxItems = $('#datatable-example tbody :checkbox:checked').map(function () {
            return this.value;
        }).get();
        if (selectedCheckboxItems.length > 0) {
            ...
            if (delMsg) {
                var verify = confirm(delMsg + 'Are you sure you want to delete ?');
            } else {
    ...
    $(document).on('click', '.markaction #show', function (e) {
        ...
        if (selectedCheckboxItems.length > 0) {
            ...
            $('#ids').attr('value', selectedItems);
            $('#bulkaction').attr('action', showUrl);
            $('#bulkaction').submit();
    ...
    $(document).on('click', '.markaction #hide', function (e) {
        ...
        //console.log(selectedCheckboxItems);
        if (selectedCheckboxItems.length > 0) {
            selectedItems = selectedCheckboxItems.join(',');

            $("#progressbar").show();
            $('#ids').attr('value', selectedItems);
            $('#bulkaction').attr('action', hideUrl);
            $("#bulkaction").submit();
        } else {
            showErrorMessage('Nothing Selected');
